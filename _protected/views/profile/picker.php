...
<div class="user-index">
    <section class="content-header">
        <h1><?= Yii::t('app', 'Choose ') . Yii::t('app', ucwords($modelAttribute)) ?></h1>
    </section>
                            ...
                            'add' => function ($url, $model) {
                                return Html::button('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Add'),
                                    [
                                        ...
                                        'onclick' => 'addButtonClick("' . $model->name . '","' .
                                            $model->id . '")'
                                    ]);
                            }
                        ]
...
<script>
    function addButtonClick(name, id) {
        inputName = "<?= $modelName ?>[<?=$modelAttribute ?>][]";
        $("#profileModal").modal("hide");
        $("#<?=$modelAttribute?>>tbody:last").append("<tr><td style='text-align: center'></td><td>" + name +
